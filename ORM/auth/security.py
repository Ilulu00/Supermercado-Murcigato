"""
Módulo de seguridad para manejo de contraseñas de usuario
"""
...
class PasswordManager:
    ...
    def hash_password(password: str) -> str:
        """
        Generar codigo hash seguro de una contraseña

        Args:
            password: Contraseña
        Returns:
            Codigo Hash de la contraseña con salt
        """
    ...
    def verify_password(password: str, password_hash: str) -> bool:
        """
        Verificar si una contraseña coincide con su codigo hash

        Args:
            password: Contraseña
            password_hash: Codigo Hash almacenado
