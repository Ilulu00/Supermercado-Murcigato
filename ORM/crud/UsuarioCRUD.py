...
class UsuarioCRUD:
    ...
    def obtener_usuario_por_correo(self, correo: str) -> Optional[Usuario]:
        ...
        """    
        return (
            self.db.query(Usuario).filter(Usuario.correo == correo.lower().strip()).first()
        )
    ...
    def cambiar_contraseña(self, id_usuario: UUID, contraseña_actual: str,nueva_contraseña: str) -> bool:
